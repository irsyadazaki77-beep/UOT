...
test("A11y Audit: Global Sound Engine & No Autoplay", () => {
    const soundEngine = fs.readFileSync(path.join(__dirname, "sound-engine.js"), "utf-8");
...
test("A11y Audit: Focus-Visible & Reduced Motion in CSS", () => {
    const responsiveCss = fs.readFileSync(path.join(__dirname, "responsive-system.css"), "utf-8");
...
test("A11y Audit: Escape Key, Focus Trap, & Form Label Helpers in app-shell.js", () => {
    const appShell = fs.readFileSync(path.join(__dirname, "app-shell.js"), "utf-8");
